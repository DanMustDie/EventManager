    ...
    if(isset($_POST['option'])){
        ...
        if($_POST['option'] == 'sign-up'){
            if($select_result->num_rows > 0){
                $error_m = "Account already exists. Please log in into existing account.";
            }else{
...
<body>
    ...
    <form id='main-form' action='' method='post'>
        ...
        <div class='logging-in'><label for='password'>Password: </label><input type='password' name='password' value='123456' required/></div>
