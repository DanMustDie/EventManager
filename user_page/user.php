...
<body>
    ...
    <div><button onclick=showCreated(1)>Show created events</button><button onclick=showCreated(0)>Show available events</button> <a href=<?= './create_event.php?creator_id='.$user['id']?>><button>Create your event!</button></a> </div>
    <ol id='button-res'></ol>
